                ...
                <tr>
                    ...
                    <td>
                        <?php if (isset($order['id'])): ?>
                            <a href="/admin/orders/edit/<?= $order['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="/admin/orders/<?= $order['id'] ?>" class="btn btn-success btn-sm">Xem</a>
                            <a href="/admin/orders/delete/<?= $order['id'] ?>" class="btn btn-danger btn-sm"
